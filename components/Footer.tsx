      ...
      <div className="bg-surface-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
          ...
          <div className="glass rounded-xl p-4 border border-white/[0.07] mb-6 flex items-center gap-4">
            <a
              href="https://khalidkshaikh.github.io/"
              target="_blank"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-violet-600/20 border border-violet-500/30 text-violet-300 text-xs font-semibold hover:bg-violet-600/30 transition-colors"
            >

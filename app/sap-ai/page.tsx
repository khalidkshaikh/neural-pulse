...
import { sapUpdates } from '@/lib/mockData';
import type { SAPProduct } from '@/lib/types';
        ...
        <div className="space-y-6">
                ...
                <div key={product}>
                  ...
                  <div className="h-1 bg-white/5 rounded-full">
                    <div
                      ...
                      style={{ width: `${(count / Math.max(...Object.values(statsMap))) * 100}%` }}
                    />
                  </div>
                </div>
              ))}
          ...
          <div className="glass rounded-xl p-4 border border-white/[0.07]">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-slate-500">SAP sources checked every 6 hours</span>
            </div>
          </div>
        </div>
      </div>
